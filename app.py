...
class HeaderBanner(Flowable):
    ...
    def draw(self):
        ...
        c.drawString(20, self.height - 35, "PlantCare AI")
...
class FooterBanner(Flowable):
    ...
    def draw(self):
        ...
        c.drawString(0, self.height - 15, "Generated by PlantCare AI | Powered by MobileNetV2")
...
def download_report():
    ...
    elements.append(Paragraph("<b>PlantCare AI - Detailed Analysis Report</b> (Page 2)", ParagraphStyle('P2H', parent=style_subtitle, textColor=colors.HexColor("#16a34a"))))
    ...
    code_cell = [
        ...
        Paragraph("Visit plantcareai.com for detailed guides", style_center)
    ]
    ...
    return send_file(
        buffer,
        as_attachment=True,
        download_name=f"PlantCare_Report_{prediction['plant_name']}_{date_str2}.pdf",
